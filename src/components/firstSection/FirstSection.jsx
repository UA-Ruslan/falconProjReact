...
import car1 from "../../img/fifth_section/car1.png"
import car2 from "../../img/fifth_section/car2.png"
import car from "../../img/fifth_section/car.png"
import block from "../../img/fifth_section/yellow_block.png"
import block1 from "../../img/fifth_section/yellow_block1.png"
    ...
    return (
        <div className={style.firstSection}>
            ...
            <img className={headerBtnActive ? style.imgCar1 + " " + style.newImgCar1 : style.imgCar1} src={car1}
                 alt="img"/>
            <img className={firstSectionBtnActive ? style.imgCar2 + " " + style.newImgCar2 : style.imgCar2} src={car2}
                 alt="img"/>
            <img className={headerBtnActive ? style.imgCar + " " + style.newImgCar : style.imgCar} src={car} alt="img"/>
